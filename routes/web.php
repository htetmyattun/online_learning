...
Route::prefix('student')->group(function() {
    ...
    // Route::post('detail-course', 'studentController@detail_course')->name('student_detail_course');
    // Route::get('course-resource', 'studentController@course_resource')->name('student_course_resource');
    Route::post('course-resource', 'studentController@course_resource')->name('student_course_resource');
    Route::get('course-content/{c_id}&{id}', 'studentController@course_content')->name('student_course_content');
    // Route::post('course-content', 'studentController@course_content')->name('student_course_content');
