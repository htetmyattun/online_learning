		...
		<div class="row">
					...
					<div class="page-breadcrumb">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Add Exam Quiz</li>
							</ol>
						</nav>
					</div>
				 </div>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<li class="list-group-item ">
                        ...
                        <span class="social-sales-count text-dark">
							<div class="dd-nodrag btn-group ml-auto">
								<a href="/lecturer/edit-exam-quiz/{{$question->id}}" class="btn btn-outline-light">Edit</a>
								<a href="" class="btn btn-outline-light" data-toggle="modal" data-target="#exam_quiz_question_deleteModal_{{$question->id}}"> <i class="far fa-trash-alt"></i></a>
							</div>
						</span> 
					</li>
					@endforeach
				...
				<div class="card card-body">
					<form action="{{route('lecturer_save_exam_quiz')}}" method="post" enctype="multipart/form-data">
						@csrf
