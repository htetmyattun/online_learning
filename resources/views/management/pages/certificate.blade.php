...
<tr style="color:black">
    ...
    <td>{{$c1->email}}</td>
    <td>{{$c1->cname}}</td>
    <td class="thampnail_img"><a href="{{ asset(\App\Http\Controllers\studentController::show_image((string)$c1->certificate_photo)) }}"><img src="{{ asset(\App\Http\Controllers\studentController::show_image((string)$c1->certificate_photo)) }}"></a></td>
